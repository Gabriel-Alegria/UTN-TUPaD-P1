...
if edad >= 18 and edad <= 30:
    ...
    print("Usted pertenece a la categoria Adolesente")
else:
...
if palabra[-1].lower() in vocales:     # "palabra[-1]" accede al último carácter. "in" verifica si ese carácter está en el conjunto de vocales.
    print(f"{palabra}!")
else:
    print(f"{palabra}")
...
#            20 de junio (incluidos)
# 
#       Desde el 21 de junio hasta el                                   Verano                                  Invierno 
#       20 de septiembre (incluidos)
#   
...
hemisferio = input("Ingrese en qué hemisferio se encuentra (N/S): ").strip().lower()
mes = int(input("Ingrese el número del mes (1-12): "))
dia = int(input("Ingrese el día del mes: "))

# Convertimos fecha a una tupla para facilitar comparaciones
fecha = (mes, dia)
